...
public class TableForm extends javax.swing.JFrame {
     ...
     */
    public TableForm() {
        AdapterTable adapterTable = new AdapterTable();
        ArrayList<SinhVien> listSV = new ArrayList<>();
        listSV.add(new SinhVien("Dang Hoai Phong", "13/11/1999", "Ninh Hoa, Khanh Hoa"));
        listSV.add(new SinhVien("Nguyen Van A", "23/1/1999", "Ninh Hoa, Khanh Hoa"));
        listSV.add(new SinhVien("Duong Van B", "3/11/1999", "Ninh Hoa, Khanh Hoa"));
        initComponents();
        tableSV.setModel(adapterTable.listAdapter(listSV));
    }
